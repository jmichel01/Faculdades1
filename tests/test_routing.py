...
def test_vehicle_metrics() -> None:
    ...
    assert metrics["fuel_liters"] == 0.8
    assert metrics["fuel_cost_usd"] == 1.20
    assert metrics["co2_emissions_g"] == 1200.0
...
def test_tsp_solver() -> None:
    ...
    destinations = [
        {"lat": 47.6080, "lng": -122.3350},
        {"lat": 47.6150, "lng": -122.3500},
        {"lat": 47.6100, "lng": -122.3400}
    ]
