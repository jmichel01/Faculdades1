...
class DemandForecaster:
    """
    Core machine learning pipeline for demand forecasting.
    Handles feature engineering, train-test splits, and regressor validation.
    """
    @staticmethod
    def prepare_features(df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.Series]:
        ...
        # Categorical encoding for weather
        weather_dummies = pd.get_dummies(df["weather"], prefix="weather", drop_first=False)
        
        # Force column alignment for standard weather variables
